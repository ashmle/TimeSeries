...
This project contains the Jupyter Notebooks and the associated Dockerfile for Sanjian Chen and Jian Chang's _Building intelligent analytics through time series data_. It contains both the exercises (/notebooks), as well as any data or files needed.

This is a public repository so there is no need to create an account to download its contents. To download the source code from this page, click the 'Cloud' icon on the top right hand, above where the latest commit is detailed.

To download via git from your preferred terminal application, type: 

```git clone https://resources.oreilly.com/binderhub/building-intelligent-analytics-through-time-series-data```
