...
import six
import ts_profiling
from ts_profiling.describe import describe, describe_1d
from ts_profiling.report import to_html
import tempfile
import shutil
import os
check_is_NaN = "ts_profiling.check_is_NaN"
...
class DataFrameTest(unittest.TestCase):
    ...
    def test_export_to_file(self):
        ...
        p = ts_profiling.ProfileReport(self.df)
